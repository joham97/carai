...
public class NeuralNetwork {
	...
	/// <summary>
	/// Initialises a new fully connected feedforward neural network with given
	/// topology.
	/// </summary>
	/// <param name="topology">An array of unsigned integers representing the node
	/// count of each layer from input to output layer.</param>
